...
SELECT m.mascota_id, m.nombre, m.fecha_ingreso, ROUND(MONTHS_BETWEEN(SYSDATE, m.fecha_nacimiento)/12,1) edad,
...
SELECT c.cliente_id, c.nombre || ' ' || c.apellido_paterno || ' ' || c.apellido_materno nombre, m.fecha_status,
